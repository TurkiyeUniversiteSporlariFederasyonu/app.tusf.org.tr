module.exports = (req, res) => {
  ...
  return res.render('settings/university', {
    page: 'settings/university',
    title: 'Üniversite Ayarları',
    includes: {
      external: {
    ...
    type_names,
    cities: user.university.is_cyprus_university ? cyprus_cities : cities
  });
}
